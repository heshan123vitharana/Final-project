                          ...
                          <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden">
                            ...
                            <div className="p-8 max-h-[60vh] overflow-y-auto">
                              ...
                              <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <button
                                  type="submit"
                                  className="w-full py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold rounded-xl shadow-lg transition-all duration-300 hover:bg-green-700 focus:outline-none focus:ring-4 focus:ring-green-500/20"
                                  disabled={isLoading}
                                >
