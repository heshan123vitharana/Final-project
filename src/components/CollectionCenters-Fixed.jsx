...
const CollectionCenters = () => {
  ...
  const districts = [...new Set(centers.map(center => center.district))].sort();

  // Simple filtering function
  const getFilteredCenters = () => {
    console.log('Current filters:', { searchTerm, selectedDistrict, selectedStatus });
    ...
    console.log('Filtered centers:', filtered.length, 'out of', centers.length);
    return filtered;
  };
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-12 border border-green-100">
          ...
          <div className="mt-6 text-center">
            ...
            <div className="mt-2 text-xs text-gray-500 bg-gray-50 p-2 rounded">
              Debug: Search="{searchTerm}" | District="{selectedDistrict}" | Status="{selectedStatus}"
            </div>
          </div>
        </div>
