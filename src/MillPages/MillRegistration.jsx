...
const MillRegistration = () => {
  ...
  const handleCloseForm = () => { setFormType(''); setShowForm(false); };
        ...
        <div className="bg-white rounded-lg shadow-md border border-green-200 p-6 max-w-xl">
          ...
          <form className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <button type="button" className="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700" onClick={handleCloseForm}>Cancel</button>
            </div>
          </form>
        </div>
      )}
