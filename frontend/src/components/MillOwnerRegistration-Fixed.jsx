  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-3xl max-w-5xl mx-auto shadow-2xl border border-gray-200/50">
          {/* Enhanced Header with Gradient */}
          <div className="relative bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 p-8 text-white overflow-hidden">
