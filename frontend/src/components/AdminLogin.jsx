        ...
        <div className="text-center lg:text-left text-white space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-green-100 max-w-md mx-auto lg:mx-0">
              {isSignIn ? 'Secure access to administrative dashboard and management tools' : 'Create your administrator account to access the management system'}
            </p>
          </div>
            ...
            <div className="p-8 max-h-[60vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-green-500 transition-colors duration-200"
                    >
                      {showPassword ? (
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-green-500/30 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                    ...
                    <span>{isSignIn ? 'Sign In to Admin Portal' : 'Create Admin Account'}</span>
                  )}
                </button>
                ...
                {isSignIn && (
                  <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-green-800 text-sm font-semibold mb-1">Demo Credentials:</p>
