  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center space-x-2 px-3 py-2 text-sm font-medium text-gray-700 hover:text-green-600 transition-colors duration-200 bg-white/80 hover:bg-white rounded-lg border border-gray-200 hover:border-green-300 shadow-sm"
