...
// Import toast validation system
import { validateFormWithToast, handleLoginSuccess, handleApiError } from '../utils/validation';
...
const MillLogin = ({ onLoginSuccess, onGoToSignUp, onExit, onGoToForgotPassword }) => {
  ...
  return (
    <div className="fixed inset-0 z-40 h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50 flex items-center justify-center p-6 font-inter"
        ...
        <div className="relative w-full max-w-4xl mx-auto h-[520px] bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-gray-100/50">
            ...
            <div className="flex flex-col justify-center p-6 lg:p-8 bg-white order-2 lg:order-1">
              ...
              <div className="text-center pt-3 space-y-2 pb-2">
                ...
                <div className="mt-2 mb-4">
                  <button
                    type="button"
                    className="w-full bg-white hover:bg-gray-50 border-2 border-gray-300 hover:border-blue-400 text-gray-700 hover:text-blue-600 font-semibold py-2 px-3 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center space-x-2 text-xs transform hover:scale-[1.02]"
                  >
