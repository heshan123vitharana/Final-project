          ...
          <form className="space-y-2" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className={`w-full px-3 py-1.5 bg-gray-50 border rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 transition-all duration-200 font-medium tracking-wide text-sm ${errors.nic
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-3 py-1.5 bg-gray-50 border rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 transition-all duration-200 font-medium tracking-wide text-sm ${errors.email
                  ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                  : 'border-gray-200 focus:ring-green-500 focus:border-transparent'
                  }`}
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-1.5 bg-gray-50 border rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 transition-all duration-200 font-medium tracking-wide text-sm ${errors.password
                    ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                    : 'border-gray-200 focus:ring-green-500 focus:border-transparent'
                    }`}
                  placeholder="********"
